...
우리 팀이 만든 프로젝트는 책 리뷰를 관리할 수 있는 API 서버입니다. Spring Boot로 만들었고, 로그인 기능이랑 리뷰 검색하는 기능도 넣었습니다.
...
**BaseResponse 클래스**는 API 응답을 통일된 형태로 보내주려고 만들었습니다. 성공할 때는 200, 생성할 때는 201 이런 식으로 상태코드도 정확하게 보내줍니다.
...
이번 프로젝트로 Spring Boot를 제대로 써보면서 많이 배웠습니다. 특히 QueryDSL은 처음 써봤는데 생각보다 유용해서 다음에도 쓸 것 같아요. 팀 프로젝트라서 코드 스타일도 맞춰야 하고, 공통 모듈도 만들어야 해서 혼자 할 때보다 더 신경 쓸게 많았지만 그만큼 배운 것도 많았습니다.