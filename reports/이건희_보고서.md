...
본 프로젝트를 통해 현대 웹 애플리케이션의 핵심인 보안 시스템을 직접 구현해보며, JWT와 Spring Security의 깊이 있는 이해를 얻을 수 있었습니다. 특히 토큰 기반 인증의 장단점과 실제 구현 시 고려해야 할 보안 요소들에 대해 실무적인 경험을 쌓을 수 있었습니다.