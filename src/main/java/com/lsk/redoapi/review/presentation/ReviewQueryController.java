...
public class ReviewQueryController {
    ...
    @GetMapping("/search")
    public ResponseEntity<BaseResponse<Page<ReviewResponse>>> searchReviews(
        ...
        return BaseResponse.ok(reviews);
    }

    @GetMapping("/rating/{rating}")
    public ResponseEntity<BaseResponse<Page<ReviewResponse>>> getReviewsByRating(
    ...
    public ResponseEntity<BaseResponse<Page<ReviewResponse>>> getReviewsByUser(
    ...
    @GetMapping("/book")
    public ResponseEntity<BaseResponse<Page<ReviewResponse>>> getReviewsByBookTitle(
    ...
    public ResponseEntity<BaseResponse<Page<ReviewResponse>>> getHighRatedReviews(
